...
(setq doom-font (font-spec :family "Hasklug Nerd Font" :size 14 :weight 'regular)
      doom-variable-pitch-font (font-spec :family "Roboto" :size 14)
      doom-unicode-font (font-spec :family "Hasklug Nerd Font" :size 14)
      doom-big-font (font-spec :family "Hasklug Nerd Font" :size 18))
