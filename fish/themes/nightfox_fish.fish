...
--pointer "➜"
--cycle  --inline-info
--color=fg:#f2f4f8,bg:#161616,hl:#78a9ff
--color=fg+:#f2f4f8,bg+:#161616,hl+:#3ddbd9
--color=info:#c8a5ff,prompt:#ee5396,pointer:#be95ff
--color=marker:#46c880,spinner:#be95ff,header:#87afaf'
